...
**Project Overview:** BlinkIt Sales and Performance Dashboard

# Project Goal
The primary objective of this Power BI dashboard is to provide a comprehensive, interactive view of BlinkIt's sales and operational performance across various dimensions, including item type, fat content, outlet location, size, and establishment year. The dashboard aims to enable data-driven decision-making by identifying key sales drivers, top-performing categories, and areas for potential optimization.

# Key Performance Indicators (KPIs)

The dashboard provides an immediate overview of the platform's performance:

**Total Sales**:	1 Million (1M)
**Total Items**:	9 Thousand (9K)
**Average Sales**:	141
**Average Rating**:	3.92
